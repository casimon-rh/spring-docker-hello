...
oc set probe deployment/jboss-s2i --liveness --get-url=http://:8080/demo/actuator/health --initial-delay-seconds=240
oc set probe deployment/jboss-s2i --readiness --get-url=http://:8080/demo/actuator/health --initial-delay-seconds=240
